...
verify_chromium 及 StartupError。通过 mock builtins.__import__ / importlib.util.find_spec
...
class TestCheckDependencies:
    ...
    def test_missing_one_dep_raises(self, monkeypatch):
        ...
        monkeypatch.setattr("astrocrawl._startup.find_spec", _mock_find_spec)
...
class TestCheckGuiDependencies:
    ...
    def test_pyside6_missing_raises(self, monkeypatch):
