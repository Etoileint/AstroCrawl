...
class TestVersion:
    ...
    def test_package_matches_source(self):
        assert pkg_version("astroguard") == __version__

    def test_version_in_init(self):
        from astroguard import __all__ as public_all
        from astroguard import __version__ as public_version
        from astroguard import __version_info__ as public_info
    ...
    def test_standalone_import(self):
        version_path = Path(__file__).resolve().parent.parent / "astroguard" / "_version.py"
