...
pip 依赖:   astroframe → astrobasis,  astrocrawl → astrobasis,  astroflow → astrobasis
...
pip dependency: astroframe → astrobasis,  astrocrawl → astrobasis,  astroflow → astrobasis
entry_point:    astrocrawl → astroframe.plugins,  astroflow → astroframe.plugins
```
