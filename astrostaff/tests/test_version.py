...
from astrostaff._version import __version__, __version_info__
...
class TestVersion:
    ...
    def test_package_matches_source(self):
        assert pkg_version("astrostaff") == __version__

    def test_version_in_init(self):
        from astrostaff import __all__ as public_all
        from astrostaff import __version__ as public_version
        from astrostaff import __version_info__ as public_info
    ...
    def test_standalone_import(self):
        version_path = Path(__file__).resolve().parent.parent / "astrostaff" / "_version.py"
